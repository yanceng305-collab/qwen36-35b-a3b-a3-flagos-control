...
- [tasks/QWEN36-A3-S6-TOKENIZER-NATIVE-UFFFD-AWARE-FUNCTIONAL-MATRIX-RERUN.md](tasks/QWEN36-A3-S6-TOKENIZER-NATIVE-UFFFD-AWARE-FUNCTIONAL-MATRIX-RERUN.md)：NOT READY proposal，等待D-034 User Decision。
...
Stage 1/2、Stage 3、Stage 4和Stage 5均已`ACCEPTED`；D-030 baseline不变。Diagnostic A/tokenizer-decoder-native已scope-limited Accepted，但Stage 6仍`STOP / NOT ACCEPTED`。D-034 validator semantics等待User Decision；当前无Ready Task或dispatchable prompt。Performance、prefix lifecycle和EP2保持locked。
