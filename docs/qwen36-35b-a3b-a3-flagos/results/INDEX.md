...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `QWEN36-A3-S1S2-ENV-BUILD-RUNTIME` | N/A | **READY / Awaiting explicit User dispatch** | Tracked branch；run SHA/tree在 dispatch时冻结 | N/A | N/A | Task revised with bounded authorization | PENDING / no execution |
